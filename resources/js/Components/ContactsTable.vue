        ...
        <Modal :show="showAddNewModal" @close="closeAddNewModal">
            <div class="modal">
                ...
                <div class="modal-body">
                    <!-- Autofill the fields in the edit modal -->
                    <label for="editName">Name:</label>
                    <input type="text" id="editName" v-model="newContactData.name"/>
                    <label for="editEmail">Email:</label>
                    <input type="email" id="editEmail" v-model="newContactData.email"/>
                    <label for="editPhone">Phone:</label>
                    <input type="text" id="editPhone" v-model="newContactData.phone"/>
